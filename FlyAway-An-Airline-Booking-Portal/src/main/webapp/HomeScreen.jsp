...
<form action="FlightList.jsp" method=post>
	<label for=from>Source :-</label> <input type=text name=from id=from required/><br><br>
	<label for=to>Destination :-</label> <input type=text name=to id=to required/><br><br>
	<label for=departure>Date of Departure :-</label> <input type=date name=departure id=departure required/><br><br>
	<label for=travellers>No. of Travellers :-</label> <input type=number name=travellers id=travellers required/><br><br>
